...
const sliders = ['mix', 'texture', 'feedback', 'size', 'diffusion', 'modDepth', 'modRate', 'damping', 'lowDamping', 'tone', 'shimmer', 'inputGain', 'outputGain', 'preDelay', 'stereoWidth', 'shimmerRatio', 'stereoCore', 'hardFreeze'];

...
3. Se a energia suavizada excede `0.05`, ele calcula um ganho de redução (Safety Gain) para trazer o loop de volta aos níveis sadios. O limiar considera o headroom e a saturação já aplicados no loop; material nominal permanece abaixo dele.
